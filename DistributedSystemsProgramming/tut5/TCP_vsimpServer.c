...
bool server_processing(char *instr);
...
{
	int rc, bc;
	char inbuf[BUF_LEN], outbuf[BUF_LEN], hostname[40];
	char prefix[100];
	char end_of_data = '&';
	int i;
	int revcnt;
	...
	/*
	 * Loop to continually get input
	 * from user, process it, and send
	 * back a response.
	*/
	while (1)
	{
